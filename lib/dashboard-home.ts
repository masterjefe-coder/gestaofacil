...
export const dashboardModuleCards = [
  {
    ...
    kicker: "Comercial",
    title: "Orçamentos",
    description: "Criar propostas, acompanhar negociações e avançar vendas com mais contexto.",
  },
  {
    href: "/dashboard/orders",
    kicker: "Operação",
    title: "Pedidos",
    description: "Ver serviços aprovados, agendados e em execução sem perder o ritmo da equipe.",
  },
  {
    href: "/dashboard/billing",
    kicker: "Financeiro",
    title: "Cobranças",
    description: "Receber, cobrar no prazo e acompanhar retornos sem trocar de sistema.",
  },
  {
    href: "/dashboard/customers",
    kicker: "Relacionamento",
    title: "Clientes",
    description: "Consultar histórico, follow-ups e oportunidades com uma visão mais útil da base.",
  },
  {
    href: "/dashboard/fiscal",
    kicker: "Notas",
    title: "Emissão",
    description: "Preparar, revisar e emitir notas com menos retrabalho e mais previsibilidade.",
  },
  {
    href: "/dashboard/setup#integrations-section",
    kicker: "WhatsApp",
    title: "Conexões",
    description: "Conectar o número principal e acompanhar o canal com leitura operacional clara.",
  },
  {
    href: "/dashboard/setup#subscription-section",
    kicker: "Plano",
    title: "Assinatura",
    description: "Ver plano, ciclo atual e status da cobrança recorrente com menos ruído.",
  },
  {
    href: "/dashboard/setup#team-section",
    kicker: "Empresa",
    title: "Equipe e acessos",
    description: "Gerenciar pessoas, dados da empresa e acessos em uma área mais objetiva.",
  },
] as const;
